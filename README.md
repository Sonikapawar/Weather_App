...
A simple weather web application built with Node.js, HTML and CSS. It fetches current weather data from a weather API and displays it in a clean, responsive UI.
